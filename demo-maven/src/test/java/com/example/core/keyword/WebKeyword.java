...
public class WebKeyword {
    ...
    //
    public WebKeyword selectDatePcikerByJS(WebElement webElement,String value){
        ((JavascriptExecutor)driver).executeScript("arguments[0].setAttribute('value','"+value+"')", webElement);
        return new WebKeyword(driver);
    }
